...
function addDownloadLinks(soundItem){
  var scResource = soundItem.getElementsByClassName("soundTitle__title sc-link-dark")[0].getAttribute("href");
  var scActions = soundItem.getElementsByClassName("soundActions")[0]
  var btnGroup = scActions.getElementsByClassName("sc-button-group")[0]
  var newBtn = createDownloadButton(scResource)
  btnGroup.appendChild(newBtn)
}

var sounds=document.getElementsByClassName("soundList__item");
[].forEach.call(sounds, addDownloadLinks);
